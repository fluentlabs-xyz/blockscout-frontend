...
import { FLUENT_L2_MESSAGE_ITEM } from 'stubs/fluentL2';
...
const FluentL2Withdrawals = () => {
  const { data, isError, isPlaceholderData, pagination } = useQueryWithPages({
    resourceName: 'general:fluent_l2_withdrawals',
    options: {
      placeholderData: generateListStub<'general:fluent_l2_withdrawals'>(
        FLUENT_L2_MESSAGE_ITEM,
        50,
  ...
  const countersQuery = useApiQuery('general:fluent_l2_withdrawals_count', {
    queryOptions: {
...
export default FluentL2Withdrawals;
