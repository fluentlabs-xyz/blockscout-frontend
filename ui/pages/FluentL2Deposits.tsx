...
const FluentL2Deposits = () => {
  const { data, isError, isPlaceholderData, pagination } = useQueryWithPages({
    resourceName: 'general:fluent_l2_deposits',
    options: {
      placeholderData: generateListStub<'general:fluent_l2_deposits'>(
  ...
  const countersQuery = useApiQuery('general:fluent_l2_deposits_count', {
    queryOptions: {
...
export default FluentL2Deposits;
